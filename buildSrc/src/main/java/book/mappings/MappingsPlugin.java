...
public abstract class MappingsPlugin implements Plugin<Project> {
    ...
    public void apply(@NotNull Project project) {
        ...
        final var ext = extensions.create("mappings", MappingsExtension.class, project);
        ...
        tasks.register(INTERMEDIARY_V_2_MERGED_MAPPINGS_JAR_TASK_NAME, MappingsV2JarTask.class, task -> {
        ...
        final var downloadTargetMappingsJar = tasks.register(
                ...
                task -> {
                    ...
                    task.getTargetJar().convention(task.provideVersionedProjectFile(version ->
                            Path.of(MappingsPlugin.TARGET_MAPPINGS_DIR, "book-mappings-" + version + "-v2.jar")
                    ));
                }
        );
        ...
        final var extractTargetMappingsJar = tasks.register(
                ...
                task -> {
                    ...
                    task.getExtractionDest().convention(task.provideVersionedProjectDir(version ->
                            Path.of(MappingsPlugin.TARGET_MAPPINGS_DIR, "book-mappings-" + version)
                    ));
                }
        );
