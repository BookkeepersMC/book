...
import book.mappings.util.MappingsJavadocProvider;
...
public abstract class DecompileTargetTask extends DecompileTask implements UnpickVersionsMatchConsumingTask {
    ...
    public void decompile() {
        ...
        try {
            final MappingsJavadocProvider javadocProvider = new MappingsJavadocProvider(this.getTargetMappingsFile().get().getAsFile(), this.getNamespace().get());
